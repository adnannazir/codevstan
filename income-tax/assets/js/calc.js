...
const slabs=[["Salary income is under PKR 600,000","If the annual salary income does not exceed PKR. 600,000 then the rate of the income tax is 0%"],["Salary income exceeds PKR 600,000 but is under PKR 1.2 Million","If the annual salary income exceeds PKR. 600,000 but does not exceed PKR. 1.2 million then the rate of income tax is 1% of the amount exceeding PKR. 600,000."],["Salary income exceeds PKR 1.2 Million but is under PKR 2.2 Million","If the taxable annual income exceeds PKR. 1.2 million but does not exceed PKR. 2.2 million then the rate of income tax is PKR. 6,000 + 11% of the amount exceeding PKR. 1.2 million."],["Salary income exceeds PKR 2.2 Million but is under PKR 3.2 Million","If the annual salary income exceeds PKR. 2.2 million but does not exceed PKR. 3.2 million then the rate of income tax is PKR. 116,000 + 20% of the amount exceeding PKR. 2.2 million."],["Salary income exceeds PKR 3.2 Million but is under PKR 4.1 Million","If the annual salary income exceeds PKR. 3.2 million but does not exceed PKR. 4.1 million then the rate of income tax is PKR. 316,000 + 25% of the amount exceeding PKR. 3.2 million."],["Salary income exceeds PKR 4.1 Million but is under PKR 5.6 Million","If the annual salary income exceeds PKR. 4.1 million but does not exceed PKR. 5.6 million then the rate of income tax is PKR. 541,000 + 29% of the amount exceeding PKR. 4.1 million."],["Salary income exceeds PKR 5.6 Million but is under PKR 7 Million","If the annual salary income exceeds PKR. 5.6 million but does not exceed PKR. 7 million then the rate of income tax is PKR. 976,000 + 32% of the amount exceeding PKR. 5.6 million."],["Salary income exceeds PKR 7 Million","If the annual salary income exceeds PKR. 7.0 million then the rate of income tax is PKR. 1,424,000 + 35% of the amount exceeding PKR. 7.0 million."]];


document.getElementById("tax-slabs-table").innerHTML =
    slabs.map(s => `
        <tr>
            <td class="align-left">
                <h3>${s[0]}</h3>
...
const taxSlabs = [
    ...
    { slab_year_id: 10, year_id: "2026-2027", slabs: [
        { min_amount: 0, max_amount: 600000, fixed_amount: 0, rate: 0 },
        { min_amount: 600001, max_amount: 1200000, fixed_amount: 0, rate: 1 },
        { min_amount: 1200001, max_amount: 2200000, fixed_amount: 6000, rate: 11 },
        { min_amount: 2200001, max_amount: 3200000, fixed_amount: 116000, rate: 20 },
        { min_amount: 3200001, max_amount: 4100000, fixed_amount: 316000, rate: 25 },
        { min_amount: 4100001, max_amount: 5600000, fixed_amount: 541000, rate: 29 },
        { min_amount: 5600001, max_amount: 7000000, fixed_amount: 976000, rate: 32 },
        { min_amount: 7000001, max_amount: 2147483647, fixed_amount: 1424000, rate: 35 },
    ] }
];
